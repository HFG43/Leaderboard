...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _scores_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scores.js */ \"./src/scores.js\");\n/* harmony import */ var _url_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./url.js */ \"./src/url.js\");\n/* harmony import */ var _dynamics_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dynamics.js */ \"./src/dynamics.js\");\n\n// import { setNewScore, getScores } from './fectch.js';\n\n// import getGameId from './getGameId.js';\n\n\n\nconst setNewScore = async (newScore) => {\n  try {\n    const result = await fetch(await (0,_url_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(), {\n      method: 'POST',\n      body: JSON.stringify(newScore),\n      headers: {\n        'Content-type': 'application/json; charset=UTF-8',\n      },\n    });\n    const newScoreResult = await result.json();\n    return newScoreResult;\n  } catch (error) {\n    return error;\n  }\n};\n\nconst addScore = async (newScore) => {\n  const scoreContainer = document.createElement('li');\n  scoreContainer.innerText = `${newScore.user}: ${newScore.score}`;\n  scoreContainer.classList.add('score_item');\n  _dynamics_js__WEBPACK_IMPORTED_MODULE_3__.scoreListContainer.appendChild(scoreContainer);\n};\n\nconst addScores = async (savedScores) => {\n  savedScores.result.forEach((score) => {\n    addScore(score);\n  });\n};\n\nconst getScores = async () => {\n  const resultSaved = await fetch(await (0,_url_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])());\n  const savedScores = await resultSaved.json();\n  addScores(savedScores);\n};\ngetScores();\n\n_dynamics_js__WEBPACK_IMPORTED_MODULE_3__.form.addEventListener('submit', (event) => {\n  event.preventDefault();\n  const name = _dynamics_js__WEBPACK_IMPORTED_MODULE_3__.playerName.value;\n  const score = _dynamics_js__WEBPACK_IMPORTED_MODULE_3__.playerScore.value;\n  const newScore = new _scores_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"](name, score);\n  setNewScore(newScore);\n  addScore(newScore);\n  _dynamics_js__WEBPACK_IMPORTED_MODULE_3__.form.reset();\n});\n\n_dynamics_js__WEBPACK_IMPORTED_MODULE_3__.refreshScores.addEventListener('click', () => {\n  _dynamics_js__WEBPACK_IMPORTED_MODULE_3__.scoreListContainer.innerHTML = '';\n  getScores();\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
